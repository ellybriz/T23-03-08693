...
function displayGreeting() {
    ...
    if (!greetingElement) return; // Exit if the greeting element is not found
...
if (contactForm) {
    contactForm.addEventListener('submit', function(event) {
        ...
        const phoneRegex = /^\d{10}$/; // Adjust as needed for your phone number format
        ...
        if (isValid) {
            // Simulate form submission (replace with actual AJAX/fetch if needed)
